...
main = () => {
  ...
  const myArray = new javascript_array(process.argv.splice(2));
  while (true) {
    let command = prompt("list perform: ");
    ...
    switch (command) {
      ...
      case "t":
        ...
        break;
      case "i":
        let insertCommand = prompt("($element $index): ");
        let argList = insertCommand.split(" ");
